---
name: one-shot-website
description: High-fidelity, cinematic "1:1 Pixel Perfect" landing page builder. Ask the user 4 specific questions, then build a stunning React+Tailwind+GSAP website in one shot without placeholders.
---
